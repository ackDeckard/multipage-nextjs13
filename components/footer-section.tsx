...
export default function FooterSection() {
  ...
  return (
    ...
    >
      ...
      <div className="md:mx-auto md:grid md:max-w-[689px] md:grid-flow-col  md:justify-between lg:max-w-[1111px]">
        {/* ------------------------- */}
        {/* ADDRESS SECTION  */}
        {/* ------------------------- */}
        ...
        {/* SOCIAL  ICONS  */}
        {/* ------------------------- */}
        {/* Note: Tailwind requires direct manipulation of the svgs files, that's why the images are inline in the code  */}
        {/* ------------------------- */}

        <div className="md:item mx-auto mb-10 grid h-[24px] w-[184px] grid-flow-col place-items-center  hover:cursor-pointer md:mb-10 md:place-items-end md:self-end">
          <svg
            className="fill-current text-customHoverColor hover:text-customHoverColorSecond"
            width="24"
            height="24"
